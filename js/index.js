...
var d1 = jsdata.critical["tbl_critical_coal_plant"][0]["number"];
var d2= jsdata.scritical["tbl_super_critical_coal_plant"][0]["number"];
console.log(d1);
console.log(d2);
...
var ChartName=jsdata.ChartName;
 energy_shortage=[{"actual":es[esDaily][0]["actual"],"target":es[esDaily][0]["target"],"percent":es[esDaily][0]["percent"]}
...
function start() {
	...
	var rps = map(function(rowind, row){
		//if (rowind=="energy_shortage" || rowind=="peak_power_shortage") {
		//	console.log("last two")
			//print("last two parts");
	//	}
	//	else{
			//print("this is other part")
	//	console.log("other")
	//	}
		//console.log(row);
